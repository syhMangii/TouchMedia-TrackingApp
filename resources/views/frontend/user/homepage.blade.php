            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    ...
                    <img src="images/logo TM.png" alt="" class="custom-image">
                        <span>TouchMedia Computer Tracking Page again heheh</span>
                    </a>
                ...
                <div class="container">
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-lg-5 col-12 mb-5">                            
                            ...
                            <h2 class="text-white">Track Your Computer <br>Easily!</h2>                            
                        </div>
        <!-- HAVENT CHANGE THE POST METHOD YET AND NOT YET CONNECT WITH DATABASE AND CONTROLLER -->
                        <div class="col-lg-5 col-12">
                        <form class="custom-form subscribe-form" action="#" method="post" role="form">
                                <h4 class="mb-4 pb-2">Insert Tracking Number:</h4>

                                <input type="email" name="subscribe-email" id="subscribe-email" class="form-control" placeholder="Ex: QN77819323212" required="">

                                <div class="col-lg-12 col-12">
                                    <button type="submit" class="form-control">find Computer</button>
                                </div>
                            </form>
                        </div>
